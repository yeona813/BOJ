...
### 메모
<p>열린 괄호가 나올 때마다 카운트하고 닫힌 괄호가 나올 때 -1씩 감소하여 문제를 해결할 수 있다. 마지막 괄호까지 도달했을 때, 열려 있는 괄호의 개수가 0을 초과하거나 계산 도중 열려 있는 괄호의 개수가 0 미만이 되면 올바른 괄호 문자열이 아니라고 판단하여 코드를 구현하였다. </p>
